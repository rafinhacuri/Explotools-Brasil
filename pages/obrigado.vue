    ...
    <div class="relative z-10">
      ...
      <div class="px-4 py-6 md:px-32">
        ...
        <div class="mt-10 flex justify-center space-x-5">
          ...
          <NuxtLink v-tooltip.top="'LinkedIn'" to="www.linkedin.com/in/explotools-brasil-b6ba58273" external target="_blank" class="text-[#FD0116] transition-all duration-300 hover:drop-shadow-[0_0_5px_#FD0116] ">
            <svg class="size-10" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
